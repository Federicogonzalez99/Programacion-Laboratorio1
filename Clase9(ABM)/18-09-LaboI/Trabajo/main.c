...
int NuevoEstudiante(Persona arrayPersonas[],int indiceLugarLibre,char auxiliarNombreStr[],char auxiliarApellidoStr[],int auxiliarLegajo);
    ...
    while(opcion != 6)
    {
         ...
         switch(opcion)
         {
            case 1:
                ...
                NuevoEstudiante(arrayPersonas,indiceLugarLibre,auxiliarNombreStr,auxiliarApellidoStr,auxiliarLegajo);
                //
            ...
            case 3:
                ...
                NuevoEstudiante(arrayPersonas,indiceResultadoBusqueda,auxiliarNombreStr,auxiliarApellidoStr,auxiliarLegajo);
